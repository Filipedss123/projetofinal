    ...
    <div class="scroll">
        ...
        <section class="sections">
         ...
         <section class="bloco" id="agenda">
            ...
            <div class="catalogo2">
                ...
                <div class="catalogopainel">
                    ...
                    <div class="imgcatalogo"><img src="img/Gears.jfif"></div>
                </div>
                <div class="catalogopainel">
         ...
         <section class="bloco" id="contato">
             <form action="index.php" target="_blanck" method="POST">
                 <fieldset>
                     <div class="contform">
                         <label>Nome</label>
                         <input type="text" placeholder="Nome Completo" >
                         <label><E-mail>E-mail</E-mail></label>
                         <input type="mail" placeholder="email@email.com.br"/>
                         <label>Telefone:</label>
                         <input type="phone" placeholder="(00)0000-0000">
                         <label>Cidade</label>
                         <input type="text" placeholder="escreva sua cidade">
                         <label>Estado</label>
                         <input type="text" placeholder="escreve seu Estado">
